...
BEGIN
    ...
    SET @cNewDescription = 'Book_Images';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Book_Images';
    ...
    -- Fixed displaying images in books

UPDATE `page_text` SET 
	`text`='<HTML>\r\n<BODY>\r\n<IMG src=\"Interface\\Pictures\\9330_Gammerita_sepia_256\"/>\r\n</BODY>\r\n</HTML>' 
WHERE `entry` = 1171;

UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\9330_Gammerita_sepia_256\"/> </BODY> </HTML>' 
WHERE `entry` = 1190;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\Linken_sepia_256px\"/> </BODY> </HTML>' 
WHERE `entry` = 1391;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <H1 align=\"center\"> EASTERN PYLON TABLE DIAGRAM </H1> <BR/> <IMG src=\"Interface\\Pictures\\11482_crystals_east\"/> </BODY> </HTML>' 
WHERE `entry` = 1530;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <H1 align=\"center\"> WESTERN PYLON TABLE DIAGRAM </H1> <BR/> <IMG src=\"Interface\\Pictures\\11482_crystals_west\"/> </BODY> </HTML>' 
WHERE `entry` = 1550;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\11733_blackrock_256\"/> </BODY> </HTML>' 
WHERE `entry` = 1642;

UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\11733_blasted_256\"/> </BODY> </HTML>' 
WHERE `entry` = 1643;

UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\11733_ungoro_256\"/> </BODY> </HTML>' 
WHERE `entry` = 1644;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\11733_bldbank_256\"/> </BODY> </HTML>' 
WHERE `entry` = 1646;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\11733_whipper_256\"/> </BODY> </HTML> ' 
WHERE `entry` = 1651;
...
UPDATE `page_text` SET 
	`text`='<HTML> <BODY> <IMG src=\"Interface\\Pictures\\14679_Tirion_256\"/> </BODY> </HTML> ' 
WHERE `entry` = 2370;
