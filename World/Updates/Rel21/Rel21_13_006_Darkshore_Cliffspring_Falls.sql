...
BEGIN
    ...
    SET @cNewDescription = 'Darkshore_Cliffspring_Falls';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Darkshore_Cliffspring_Falls';
...
DELETE FROM pool_creature_template WHERE id=7017 AND pool_entry=1215;
