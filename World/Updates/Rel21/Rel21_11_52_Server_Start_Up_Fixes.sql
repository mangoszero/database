...
BEGIN
    ...
    SET @cNewDescription = 'Server_Start_Up_Fixes';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Server_Start_Up_Fixes';
...
-- these should not even be in the database
DELETE FROM db_scripts WHERE script_guid=2700;
