...
BEGIN
    ...
    SET @cNewDescription = 'Implement SchoolImmunity Mask';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Implement SchoolImmunity Mask';
...
UPDATE `creature_template` SET `SchoolImmuneMask`=4 WHERE `Entry`=2447;
UPDATE `creature_template` SET `SchoolImmuneMask`=4 WHERE `Entry`=2760;
UPDATE `creature_template` SET `SchoolImmuneMask`=16 WHERE `Entry`=2761;
UPDATE `creature_template` SET `SchoolImmuneMask`=64 WHERE `Entry`=6109;
UPDATE `creature_template` SET `SchoolImmuneMask`=124 WHERE `Entry`=10485;
