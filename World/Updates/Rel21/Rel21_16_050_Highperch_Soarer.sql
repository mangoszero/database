...
BEGIN
    ...
    SET @cNewDescription = 'Highperch Soarer';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Highperch Soarer';
...
UPDATE `creature` SET `position_x` = -5075.835449, `position_y` = -1013.62237, `position_z` = 53.007923, `Spawndist` = 10, `MovementType` = 1 WHERE `guid` = 21708;
