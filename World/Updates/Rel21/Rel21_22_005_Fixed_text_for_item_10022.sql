...
BEGIN
    ...
    SET @cNewDescription = 'Fixed text for item 10022';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Fixed text for item 10022';
...
-- Fixed text for item 10022 (Proof of Deed): correct syntax now used for player name.
