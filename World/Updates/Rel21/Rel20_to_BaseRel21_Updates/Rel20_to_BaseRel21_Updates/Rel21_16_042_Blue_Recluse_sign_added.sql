...
BEGIN
    ...
    SET @cNewDescription = 'Blue Recluse sign added';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Blue Recluse sign added';
...
DELETE FROM `gameobject` where `id` = 2169;
...
(2169,0,-9036.7,842.991,109.076,0.410153,0,0,0.203642,0.979045,180,255,1);
