...
BEGIN
    ...
    SET @cNewDescription = 'Object_180660_support';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Object_180660_support';
    ...
    -- Adds a Drop-point location for the "Bag of Gold" item. This is a portion of the total update required for the quest Quest ID:8606, Decoy!
	...
	(180660,1,5086.19,-5116.32,931.162,4.78877,0,0,0.679593,-0.733589,-150,0,1);
