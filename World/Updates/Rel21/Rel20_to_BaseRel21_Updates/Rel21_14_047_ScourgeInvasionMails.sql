...
BEGIN
    ...
    SET @cNewDescription = 'ScourgeInvasionMails';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'ScourgeInvasionMails';
...
UPDATE
	`quest_template`
SET
	`RewMailDelaySecs` = 21600
WHERE
	`entry` IN (9295, 9299, 9300, 9301, 9302, 9304);
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 172
WHERE
	`entry` = 9299;
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 173
WHERE
	`entry` = 9295;
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 174
WHERE
	`entry` = 9300;
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 175
WHERE
	`entry` = 9302;
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 176
WHERE
	`entry` = 9301;
UPDATE
	`quest_template`
SET
	`RewMailTemplateId` = 177
WHERE
	`entry` = 9304;
