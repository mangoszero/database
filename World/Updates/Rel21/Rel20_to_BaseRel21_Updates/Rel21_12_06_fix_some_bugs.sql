...
BEGIN
    ...
    SET @cNewDescription = 'fix some bugs';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'fix some bugs';
    ...
    IF (@cCurResult = @cOldResult) THEN    -- Does the current version match the expected version
		...
		-- map invalid_radius error
		UPDATE creature ct set ct.spawndist=20, ct.MovementType=1 where ct.id in(12239,12240,12241,12242,12243) and ct.MovementType=0;   
