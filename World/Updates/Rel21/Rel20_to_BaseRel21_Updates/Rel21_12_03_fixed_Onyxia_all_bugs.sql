...
BEGIN
    ...
    SET @cNewDescription = 'fixed Onyxia all bugs';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'fixed Onyxia all bugs';
    ...
    IF (@cCurResult = @cOldResult) THEN    -- Does the current version match the expected version
		...
		-- fixed Onyxia Eggs not work
			UPDATE `gameobject_template` SET `faction` = '35',`data3` = '17646' WHERE `entry` = '176511';
		-- fixed Onyxia Eggs spawn times
			UPDATE `gameobject` SET `spawntimesecs` = '60' WHERE `id` = '176511'; 
		-- fixed Onyxia Armor and Damage
		...
		-- fixed Onyxia's spell complete quest 7509
