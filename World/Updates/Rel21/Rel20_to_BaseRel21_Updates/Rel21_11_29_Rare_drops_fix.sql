...
BEGIN
    ...
    SET @cNewDescription = 'Rare_drops_fix';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Rare_drops_fix';
...
-- This drastically lowers the world drop rates for epics and blues
-- A normal level 60 was finding perhaps 2 BoE epics every day - this was insanely high, hence the fix.
