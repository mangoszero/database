...
BEGIN
    ...
    SET @cNewDescription = 'Added disables table';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Added disables table.';
...
-- added text string
DELETE FROM `mangos_string` WHERE `entry` IN (714,747);

INSERT INTO `mangos_string` (`entry`,`content_default`) VALUES
 (714,'This Battleground is disabled by the server administration.'),
