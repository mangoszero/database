...
<tr bgcolor=\'#FFFFEE\'><td align=\'left\' valign=\'middle\'>0</td><td align=\'left\' valign=\'middle\'>Male</td></tr>
<tr bgcolor=\'#FEFEFF\'><td align=\'left\' valign=\'middle\'>1</td><td align=\'left\' valign=\'middle\'>Female</td></tr>
<tr bgcolor=\'#FFFFEE\'><td align=\'left\' valign=\'middle\'>2</td><td align=\'left\' valign=\'middle\'>Both</td></tr>
</table>
','<Value|<Gender
0|Male
1|Female
...
<th align=\'left\'><b>Value</b></th>
<th align=\'left\'><b>Type</b></th>
<tr bgcolor=\'#FFFFEE\'><td align=\'left\' valign=\'middle\'>0</td><td align=\'left\' valign=\'middle\'>None</td></tr>
<tr bgcolor=\'#FEFEFF\'><td align=\'left\' valign=\'middle\'>3</td><td align=\'left\' valign=\'middle\'>Flask</td></tr>
<tr bgcolor=\'#FFFFEE\'><td align=\'left\' valign=\'middle\'>16</td><td align=\'left\' valign=\'middle\'>Food granting well fed buffs</td></tr>
</table>
','<Value|<Type
0|None
3|Flask
...
<th align=\'left\'><b>Value</b></th>
<th align=\'left\'><b>Description</b></th>
<tr bgcolor=\'#FFFFEE\'><td align=\'left\' valign=\'middle\'>0</td><td align=\'left\' valign=\'middle\'>Will not appear in the spell book.</td></tr>
<tr bgcolor=\'#FEFEFF\'><td align=\'left\' valign=\'middle\'>1</td><td align=\'left\' valign=\'middle\'>Will appear in the spell book.</td></tr>
</table>
','<Value|<Description
...
update `dbdocsfields` set `FieldComment` = 'The state of the event node.', `fieldNotes` = 'The state of the event node. Node status is defined differently in every battleground script.<br /><br /><br /><b>Note:</b><br />If you update battleground scripts and make changes to node status values ensure that you provide database update scripts which update the battleground events accordingly.<br />' where `fieldId`= '18' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'This references a script using an action of the type ACTION_T_TEXT.', `fieldNotes` = 'This references a script using an action of the type ACTION_T_TEXT in the Creature AI Scripts tables entry (See creature_ai_scripts).<br /><br /><br /><b>Note:</b><br />IDs use the negative versions of the referenced action’s ID.' where `fieldId`= '103' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The creature\'s death state.', `fieldNotes` = 'The creature\'s death state. A boolean, 0 = Alive, 1 = Corpse lying dead around (no gossip possible when dead, if you need corpse-gossip use dynamicflags|32) <br />¬subtable:119¬<br /><br /><br /><b>Note:</b><br />Dead creatures can not have gossip dialogues, unless you explicitly set the dynamic flag for corpses on the “creature_template” table.<br /><br />' where `fieldId`= '41' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Base melee attack power that has been factored for low level creatures.', `fieldNotes` = 'Base melee attack power that has been factored for low level creatures.<br /><br /><br /><b>Note:</b><br />This is raw base value to be used for all melee damage calculations.' where `fieldId`= '287' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Base ranged attack power.', `fieldNotes` = 'Base ranged attack power.<br /><br /><br /><b>Note:</b><br />This is raw base value to be used for all ranged damage calculations.' where `fieldId`= '288' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The Faction If The Creature Is On The Alliance Side (See FactionTemplate.dbc).', `fieldNotes` = 'The Faction If The Creature Is On The Alliance Side (See FactionTemplate.dbc).. Just Because More Than One Faction Has The Same Name, The Inter-Faction Relationships Can Be Different.<br /><br /><br /><b>Note:</b><br />This Field Also Controls The Creature Family Assistance Mechanic. Only Creatures With The Same Faction Will Assist Each Other.' where `fieldId`= '216' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'zzzz', `fieldNotes` = 'This mask can be used to make creatures immune to spell mechanics. Multiple immunities can be combined.<br />¬subtable:123¬<br /><br /><br /><b>Note:</b><br />In theory this should somehow relate to SpellMechanic.dbc and the immunities list there, but it does not match.' where `fieldId`= '232' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The value of this field will restrict access to class and/or pet trainers', `fieldNotes` = 'The value of this field will restrict access to class and/or pet trainers, if set to a value corresponding with the class identifiers from ChrClasses.dbc.<br />¬subtable:124¬<br /><br /><br /><b>Note:</b><br />Pet trainers should always use the Hunter class identifier 3.' where `fieldId`= '267' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'Delay (sec).', `fieldNotes` = 'Delay in seconds. Note that for any delay>0, the creature is dead and cannot perform any action by itself (including cast).<br /><br /><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '352' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br /><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '355' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '346' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '347' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '348' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '349' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command. ', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br /><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '369' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br /><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '372' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '363' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '364' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '365' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '366' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br /><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '386' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br /><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '389' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '380' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '381' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands..' where `fieldId`= '382' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br /><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '383' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'Delay in seconds.The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '437' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '440' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.<br />' where `fieldId`= '431' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '432' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '433' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '434' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '403' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.<br />' where `fieldId`= '406' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '397' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '398' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '399' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands..' where `fieldId`= '400' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '420' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '423' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '414' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '415' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '416' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '417' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '454' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '457' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '474' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '465' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '466' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '467' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '468' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><br><br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '488' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><br><br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '491' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '482' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '483' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '484' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><br><br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '485' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'This field determines if an item should drop by chance, or by the character looting having a quest. The meaning is determined by the fields signedness and the value of the mincountOrRef field’s value.<br /><br />The following table shows possible combinations and their meanings.<br />¬subtable:129¬<br /><br><br /><b>Note:</b><br />Setting ChanceOrQuestChance to 0 is only allowed for entries which are part of a loot group (aka. have a groupid set). Also note that non-zero values are subject to multiplication based on the drop rate configured in the world server configuration if they are not part of a loot group.<br /><br />' where `fieldId`= '495' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'New modelID (See creature_template.ModelId1,2)', `fieldNotes` = 'New modelID of the creature (creature_template.ModelId1 or ModelId2) applied during the event.<br /><br><br /><b>Note:</b><br />Set to 0 if only the equipment should be changed.' where `fieldId`= '524' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'New equipment ID (See creature_equip_template.entry).', `fieldNotes` = 'New equipment ID (See creature_equip_template.entry) applied during the event.<br /><br /><br /><b>Note:</b><br />Set to 0 if only the model should be changed.' where `fieldId`= '521' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Event duration (minutes).', `fieldNotes` = 'The interval (in minutes) between start and end of single event occurence.<br /><br><br /><b>Note:</b><br />If length is > occurence, an event would never stop.' where `fieldId`= '515' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'GameObject ID (See gameobject_template.entry).', `fieldNotes` = 'ID of the GameObject (See gameobject_template.entry) which takes the quest.<br /><br><br /><b>Note:</b><br />Game object templates need to be of type quest giver.' where `fieldId`= '576' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The state of the event node. ', `fieldNotes` = 'The state of the event node. Node status is defined differently in every battleground script.<br /><br />Node events can occur for every node and usually describe changes due to character interaction. E.g. if stables in Arathi Basin are taken over by Alliance, the stables note state would become Alliance controlled. Similar node states exist for every battleground note.<br /><br><br /><b>Note:</b><br />If you update battleground scripts and make changes to node status values ensure that you provide database update scripts which update the battleground events accordingly.<br />' where `fieldId`= '574' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'GameObject ID (See gameobject_template.entry).', `fieldNotes` = 'ID of the GameObject (See gameobject_template_entry) that starts the quest.<br /><br><br /><b>Note:</b><br />Game object templates need to be of type quest giver.<br />' where `fieldId`= '585' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The respawn time for the game object, defined in seconds till respawn.', `fieldNotes` = 'The respawn time for the game object, defined in seconds till respawn.<br /><br><br /><b>Note:</b><br />Using a negative spawn time will lead to the object being despawned until spawned by a script. It will then despawn after the time specified here.' where `fieldId`= '571' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Not really known what this is used for at this time (see description).', `fieldNotes` = 'Not really known what this is used for at this time.<br /><br><br /><b>Note:</b><br />Set to 100 for game objects of type chest.' where `fieldId`= '559' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The name of the teleport location.', `fieldNotes` = 'The name of the teleport location.<br /><br><br /><b>Note:</b><br />Using spaces and special characters for locations is prohibited.' where `fieldId`= '541' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Gossip option ID.', `fieldNotes` = 'ID of the option of the gossip menu item, see enum Gossip_Option in GossipDef.h.<br />¬subtable:34¬<br /><br><br /><b>Note:</b><br />In order for gossip_menu_option entries to work, the npcflag of the “creature_template” table table entry needs to be set appropriately.' where `fieldId`= '636' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Gossip ID for the action (see gossip_menu.entry).', `fieldNotes` = 'Gossip ID for the action (see gossip_menu.entry).<br />The scheme allows to create chains of gossips. Typical situation is a long story NPC tells to the player, requesting menu item as a confirmation after each brief part.<br /><br><br /><b>Note:</b><br />If you want the gossip_menu_option to close the gossip window, set this field to -1.' where `fieldId`= '625' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Class of the item.', `fieldNotes` = 'Class of the item is it very general description.<br />¬subtable:16¬<br /><br><br /><b>Note:</b><br />The table only contains active classes, obsolete classes have been stripped.' where `fieldId`= '683' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The subclass of the item template.', `fieldNotes` = 'The subclass of the item template.<br />¬subtable:17¬<br /><br><br /><b>Note:</b><br />The table only contains active subclasses, obsolete classes have been stripped.' where `fieldId`= '799' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Stack size by vendors.', `fieldNotes` = 'If an item is sold in stacks, the holds the number of items in a stack.<br /><br><br /><b>Note:</b><br />If an item has limited supplies, the item is refresh to this count.' where `fieldId`= '681' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Mask of allowed classes.', `fieldNotes` = 'A bit-mask corresponding to class that should be able to use the item. The value has to match with classes defined in ChrClasses.dbc.<br />¬subtable:40¬<br /><br /><br /><b>Note:</b><br />Set to -1 to allow usage by all classes.' where `fieldId`= '672' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Mask of allowed races.', `fieldNotes` = 'A bit-mask corresponding to races that should be able to use the item. The value has to match with races defined in ChrRaces.dbc.<br />¬subtable:30¬<br /><br><br /><b>Note:</b><br />Set to -1 to allow usage by all races.' where `fieldId`= '673' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'If an item is a bag, this holds a bit-mask corresponding to bag families to whic', `fieldNotes` = 'If an item is a bag, this holds a bit-mask corresponding to bag families to which the bag belongs. The value has to match with bag families defined in ItemBagFamily.dbc.<br /><br><br /><b>Note:</b><br />Multiple bag families may be combined.' where `fieldId`= '678' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Items may have a duration set until the get removed from a character’s inventory', `fieldNotes` = 'Items may have a duration set until the get removed from a character’s inventory.<br /><br><br /><b>Note:</b><br />Items set to be deleted in real time, require ExtraFlags set accordingly.' where `fieldId`= '704' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'This table holds strings used internally by the server to allow translations.', `fieldNotes` = 'The ID that the core uses to identify a string. These IDs are contained and used internally and need to correspond to what the core expects.<br /><br><br /><b>Note:</b><br />The core will not operate if strings are missing from this table.<br />' where `fieldId`= '1105' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'This references the “npc_text” tables unique ID.', `fieldNotes` = 'This references the “npc_text” tables unique ID of the NPC text for which the entry is valid.<br /><br><br /><b>Note:</b><br />To actually make a creature display a gossip dialogue with the linked text, you will have to update the “creature_template” table as follows:<br /><p><br />SET @CREATURE_FLAG_NPC_GOSSIP                   = 1;<br /><br />&nbsp;UPDATE `creature_template`<br />&nbsp;SET<br />&nbsp;&nbsp;&nbsp;&nbsp;`NpcFlags`              = `NpcFlags` | @CREATURE_FLAG_NPC_GOSSIP,<br />&nbsp;WHERE<br />&nbsp;&nbsp;&nbsp;&nbsp;`entry`                 = YOUR-CREATURE;<br /></p><br />This will add the gossip flag to any existing flags and thus enable the link text to be displayed.' where `fieldId`= '1107' and `languageId`= 0;
