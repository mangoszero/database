...
update `dbdocsfields` set `FieldComment` = 'The state of the event node.', `fieldNotes` = 'The state of the event node. Node status is defined differently in every battleground script.<br /><b>Note:</b><br />If you update battleground scripts and make changes to node status values ensure that you provide database update scripts which update the battleground events accordingly.<br />' where `fieldId`= '18' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'This references a script using an action of the type ACTION_T_TEXT.', `fieldNotes` = 'This references a script using an action of the type ACTION_T_TEXT in the Creature AI Scripts tables entry (See creature_ai_scripts).<br /><b>Note:</b><br />IDs use the negative versions of the referenced action’s ID.' where `fieldId`= '103' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The creature\'s death state.', `fieldNotes` = 'The creature\'s death state. A boolean, 0 = Alive, 1 = Corpse lying dead around (no gossip possible when dead, if you need corpse-gossip use dynamicflags|32) <br />¬subtable:119¬<br /><b>Note:</b><br />Dead creatures can not have gossip dialogues, unless you explicitly set the dynamic flag for corpses on the “creature_template” table.<br /><br />' where `fieldId`= '41' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Base melee attack power that has been factored for low level creatures.', `fieldNotes` = 'Base melee attack power that has been factored for low level creatures.<br /><b>Note:</b><br />This is raw base value to be used for all melee damage calculations.' where `fieldId`= '287' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Base ranged attack power.', `fieldNotes` = 'Base ranged attack power.<br /><b>Note:</b><br />This is raw base value to be used for all ranged damage calculations.' where `fieldId`= '288' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The Faction If The Creature Is On The Alliance Side (See FactionTemplate.dbc).', `fieldNotes` = 'The Faction If The Creature Is On The Alliance Side (See FactionTemplate.dbc).. Just Because More Than One Faction Has The Same Name, The Inter-Faction Relationships Can Be Different.<br /><b>Note:</b><br />This Field Also Controls The Creature Family Assistance Mechanic. Only Creatures With The Same Faction Will Assist Each Other.' where `fieldId`= '216' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'Delay (sec).', `fieldNotes` = 'Delay in seconds. Note that for any delay>0, the creature is dead and cannot perform any action by itself (including cast).<br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '352' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '355' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '346' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '347' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '348' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '349' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command. ', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '369' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '372' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '363' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '364' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '365' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'Command parameter, see command description.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '366' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'The delay in seconds to apply before starting the script command.', `fieldNotes` = 'The delay in seconds to apply before starting the script command. Setting the value to 0 will instantly execute the command.<br /><b>Note:</b><br />Delay is accumulated over all events with identical id values.' where `fieldId`= '386' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Radius for the buddy search.', `fieldNotes` = 'Radius, in which the buddy will be searched. For changing source/target mechanic.<br /><b>Note:</b><br />If data_flags has SCRIPT_FLAG_BUDDY_BY_GUID set, this references an entry in the “gameobject” table or “creature” table table.' where `fieldId`= '389' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '380' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '381' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands..' where `fieldId`= '382' and `languageId`= 0;
update `dbdocsfields` set `FieldComment` = 'Command parameter, see command description.', `fieldNotes` = 'A multi-purpose data field storing signed integer values.<br /><b>Note:</b><br />Currently these fields are only used as text identifiers for the SCRIPT_COMMAND_TALK and SCRIPT_COMMAND_TERMINATE_SCRIPT commands.' where `fieldId`= '383' and `languageId`= 0;
...
update `dbdocsfields` set `FieldComment` = 'New equipment ID (See creature_equip_template.entry).', `fieldNotes` = 'New equipment ID (See creature_equip_template.entry) applied during the event.<br /><b>Note:</b><br />Set to 0 if only the model should be changed.' where `fieldId`= '521' and `languageId`= 0;
