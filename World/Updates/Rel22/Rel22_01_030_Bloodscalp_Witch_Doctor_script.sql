...
BEGIN
    ...
    SET @cNewDescription = 'Bloodscalp Witch Doctor scrip';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Bloodscalp Witch Doctor script';
...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` IN (660);
DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 660;
