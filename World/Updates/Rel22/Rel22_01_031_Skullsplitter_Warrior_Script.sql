...
BEGIN
    ...
    SET @cNewDescription = 'Skullsplitter Warrior Script';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Skullsplitter Warrior Script';
	...
	UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` IN (667);
	DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 667;
