...
BEGIN
    ...
    SET @cNewDescription = 'ItemAndSkinGroupFix';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Fix spellstone/firestone inventorytype to HOLDABLE; fix skinning_loot_template groupid from 0 to 1 for 22 Dustwallow/Bloodfen/Murk NPCs.';
    ...
    UPDATE `item_template` SET `inventorytype` = 23 WHERE `entry` IN (5522, 13602, 13603, 13699);

    UPDATE `skinning_loot_template` SET `groupid` = 1
    WHERE `entry` IN (4323,4324,4328,4329,4331,4334,4341,4343,4344,4345,4346,4347,4348,4351,4352,4356,4357,4388,4389,4390,4841,14234);
