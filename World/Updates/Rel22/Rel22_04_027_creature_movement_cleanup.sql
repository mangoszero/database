...
UPDATE creature_movement SET POINT=POINT-1 WHERE id IN (SELECT id FROM creature_movement GROUP BY id HAVING MIN(POINT)>0 ORDER BY id, POINT ASC);
UPDATE creature_movement_template SET POINT=POINT-1 WHERE entry IN (SELECT entry FROM creature_movement_template GROUP BY entry HAVING MIN(POINT)>0 ORDER BY entry, POINT ASC);

-- Finally the last few stragglers
UPDATE creature_movement SET POINT=POINT-1 WHERE id IN (SELECT id FROM creature_movement GROUP BY id HAVING MIN(POINT)>0 ORDER BY id, POINT ASC);
UPDATE creature_movement SET POINT=POINT-1 WHERE id IN (SELECT id FROM creature_movement GROUP BY id HAVING MIN(POINT)>0 ORDER BY id, POINT ASC);
UPDATE creature_movement SET POINT=POINT-1 WHERE id IN (SELECT id FROM creature_movement GROUP BY id HAVING MIN(POINT)>0 ORDER BY id, POINT ASC);
UPDATE creature_movement SET POINT=POINT-1 WHERE id IN (SELECT id FROM creature_movement GROUP BY id HAVING MIN(POINT)>0 ORDER BY id, POINT ASC);
