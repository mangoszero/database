...
BEGIN
    ...
    SET @cNewDescription = 'FixGO Rethban Ore/Root Samples';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'FixGO Rethban Ore/Root Samples';
    ...
    IF (@cCurResult = @cOldResult) THEN    -- Does the current version match the expected version
        ...
        -- ROOT SAMPLES
        -- Remove wrong loot template associations for Root Samples (all gameobjects outside of the Barrens)
        ...
        -- Copper Vein used in Rethban Cavern
