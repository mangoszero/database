...
BEGIN
    ...
    SET @cNewDescription = 'Fix_Startup_Errors';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Fix_Startup_Errors';
...
DELETE FROM game_event_mail WHERE quest NOT IN (SELECT entry FROM quest_template);
