...
BEGIN
    ...
    SET @cNewDescription = 'Holy_Light_Bonus_Data';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Add spell_bonus_data coefficient for Holy Light triggered heal';
...
DELETE FROM `spell_bonus_data` WHERE `entry` = 19968;
