...
BEGIN
    ...
    SET @cNewDescription = 'Anathek the Cruel';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Anathek the Cruel';
    ...
    -- Ana'thek the Cruel
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` IN(1059);
DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 1059;
