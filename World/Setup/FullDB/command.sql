...
('damage',3,'Syntax: .damage $damage_amount [$school [$spellid]]Apply $damage to target. If not $school and $spellid provided then this flat clean melee damage without any modifiers. If $school provided then damage modified by armor reduction (if school physical),
...
('modify aspeed',1,'Syntax: .modify aspeed #rateModify all speeds -run,swim,run back,swim back- of the selected player to \r ormalbase speed for this move type\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
('modify bwalk',1,'Syntax: .modify bwalk #rateModify the speed of the selected player while running backwards to \r ormal walk back speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
...
('modify speed',1,'Syntax: .modify speed #rate.speed #rateModify the running speed of the selected player to \r ormal base run speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
('modify standstate',2,'Syntax: .modify standstate #emoteidChange the emote of your character while standing to #emoteid.'),
('modify swim',1,'Syntax: .modify swim #rateModify the swim speed of the selected player to \r ormal swim speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
...
('npc info',3,'Syntax: .npc infoDisplay a list of details for the selected creature.The list includes:- GUID, Faction, NPC flags, Entry ID, Model ID,- Level,- Health (current/maximum),
