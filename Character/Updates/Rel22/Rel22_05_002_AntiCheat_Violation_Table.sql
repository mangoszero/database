...
BEGIN
    ...
    SET @cNewDescription = 'AntiCheat_Violation_Table';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Anti-cheat detection event log written by AntiCheatMgr::Persist and read by .anticheat report.';
    ...
    -- Anti-cheat detection events. Persisted violation log written by
    -- AntiCheatMgr::Persist (INSERT) and read by `.anticheat report` (SELECT).
    -- Created only if absent, so re-running is safe.
